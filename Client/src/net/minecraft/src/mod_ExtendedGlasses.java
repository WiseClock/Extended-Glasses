...
public class mod_ExtendedGlasses extends NetworkMod {
	public static Map invisibilities = new HashMap();
	public static final String UNIQUE_NAME = "ExtendedGlasses";
	public static final String VERSION = "0.9 BETA";
	static Configuration configuration = new Configuration(new File(Minecraft.getMinecraftDir(), "config/mod_ExtendedGlasses.cfg"));
	...
	{
		map.put(EntityGlassSack.class, new RenderThrowables(2));
		map.put(EntityPoweredGlassSack.class, new RenderThrowables(2));
	}

	public boolean onTickInGame(float time, Minecraft minecraftInstance)
    {
		//minecraftInstance.thePlayer.capabilities.disableDamage=true;
		minecraftInstance.thePlayer.capabilities.disableDamage=true;
        return true;
    }
	...
	public void load() {
		...
		MinecraftForgeClient.preloadTexture("/carlkuang/icons/items.png");
		MinecraftForgeClient.preloadTexture("/carlkuang/icons/blocks.png");
		MinecraftForgeClient.preloadTexture("/carlkuang/icons/armor/glass_1.png");
		MinecraftForgeClient.preloadTexture("/carlkuang/icons/armor/glass_2.png");
		...
		Block.blocksList[9] = (new BlockStationaryNew(9, Material.water)).setHardness(100.0F).setLightOpacity(3).setBlockName("water").disableStats().setRequiresSelfNotify();
