...
public class EntityAIBreakDoor extends EntityAIDoorInteract
{
    ...
    public boolean continueExecuting()
    {
        ...
        return this.breakingTime >= 0 && !this.targetDoor.isDoorOpen(this.theEntity.worldObj, this.entityPosX, this.entityPosY, this.entityPosZ) && var1 < 4.0D;
    }
    ...
    public void updateTask()
    {
        ...
        if (--this.breakingTime == 0 && this.theEntity.worldObj.difficultySetting == 3)
        {
